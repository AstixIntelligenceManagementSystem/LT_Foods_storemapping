...
public class AddedOutletSummaryReportActivity extends BaseActivity
{
    ...
    private TextView textView_OverAllTotal;
    private TextView textView_OverAllValidate;
    private TextView textView_OverAllPending;
    ...
    private void initialiseViews()
    {
        ...
        TextView txt_lstVisitTime = (TextView) findViewById(R.id.txt_lstVisitTime);
